---
description: Projenin uçtan uca güvenlik durumunu inceler — auth, token, ödeme, CORS, rate limiting
---

# Güvenlik İncelemesi (Review Security)
...
- Request/response body'yi tamamen loglayan middleware → UYARI
