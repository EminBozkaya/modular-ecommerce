...
export const mockCategories: Category[] = [
    { id: '1', name: 'Kategori-A', slug: 'kategori-a', isActive: true, displayOrder: 1, isDeleted: false, parentCategoryId: null, createdAt: new Date().toISOString(), createdBy: 'System' },
    { id: '2', name: 'Kategori-B', slug: 'kategori-b', isActive: true, displayOrder: 2, isDeleted: false, parentCategoryId: null, createdAt: new Date().toISOString(), createdBy: 'System' },
    { id: '3', name: 'Kategori-C', slug: 'kategori-c', isActive: true, displayOrder: 3, isDeleted: false, parentCategoryId: null, createdAt: new Date().toISOString(), createdBy: 'System' },
    { id: '4', name: 'Kategori-D', slug: 'kategori-d', isActive: true, displayOrder: 4, isDeleted: false, parentCategoryId: null, createdAt: new Date().toISOString(), createdBy: 'System' },
    { id: '5', name: 'Kategori-E', slug: 'kategori-e', isActive: true, displayOrder: 5, isDeleted: false, parentCategoryId: null, createdAt: new Date().toISOString(), createdBy: 'System' },
];
